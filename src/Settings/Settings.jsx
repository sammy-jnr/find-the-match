...
function Settings() {
    const{ setmenuOpen, currectGameInfo, setCurrectGameInfo } = useContext(GeneralContext)
    ...
    <div id='SettingsContainer'>
        ...
        <section id='selectModeSection'>
            ...
            <div id='selectModeInner' >
                <div className='selectModeItemsDiv' onClick={() =>numbersMode()}>
                    <div className='selectModeItemsImgDiv'>
                        <div className="selectModeItemsSelectOuter">
                            {currectGameInfo.mode === "numbers" && <div className="selectModeItemsSelectInner"></div>}
                        </div>
                    </div>
                ...
                <div className='selectModeItemsDiv' onClick={() =>lettersMode()}>
                    <div className='selectModeItemsImgDiv'>
                        <div className="selectModeItemsSelectOuter">
                            {currectGameInfo.mode === "letters" && <div className="selectModeItemsSelectInner"></div>}
                        </div>
                    </div>
                ...
                <div className='selectModeItemsDiv' onClick={() =>imagesMode()}>
                    <div className='selectModeItemsImgDiv'>
                        <div className="selectModeItemsSelectOuter">
                            {currectGameInfo.mode === "images" && <div className="selectModeItemsSelectInner"></div>}
                        </div>
                    </div>
        ...
        <section id='numberOfPlayersSection'>
            ...
            <div id='numberOfPlayersInner' >
                <div className='numberOfPlayersItems' onClick={() =>{numbersOfP1()}}>
                    <div className='numberOfPlayersImgDiv' >
                        <div className='numberOfPlayersSelectOuter' >
                            {currectGameInfo.numberOfPlayers === 1 &&<div className='numberOfPlayersSelectInner' ></div>}
                        </div>
                    </div>
                ...
                <div className='numberOfPlayersItems' onClick={() =>{numbersOfP2()}}>
                    <div className='numberOfPlayersImgDiv' >
                        <div className='numberOfPlayersSelectOuter' >
                            {currectGameInfo.numberOfPlayers === 2 &&<div className='numberOfPlayersSelectInner' ></div>}
                        </div>
                    </div>
                ...
                <div className='numberOfPlayersItems' onClick={() =>{numbersOfP3()}}>
                    <div className='numberOfPlayersImgDiv' >
                        <div className='numberOfPlayersSelectOuter' >
                            {currectGameInfo.numberOfPlayers === 3 &&<div className='numberOfPlayersSelectInner' ></div>}
                        </div>
                    </div>
                ...
                <div className='numberOfPlayersItems' onClick={() =>{numbersOfP4()}}>
                    <div className='numberOfPlayersImgDiv' >
                        <div className='numberOfPlayersSelectOuter' >
                            {currectGameInfo.numberOfPlayers === 4 &&<div className='numberOfPlayersSelectInner' ></div>}
                        </div>
                    </div>
        ...
        <section id='gridSizeSection'>
            ...
            <div id='gridSizeInner'>
                {currectGameInfo.gridSize === "4by4" &&<div className='gridSizeItems' style={Selected}  onClick={() => gridIs4()}>4 * 4</div>}
                {currectGameInfo.gridSize !== "4by4" &&<div className='gridSizeItems' style={NotSelected}  onClick={() => gridIs4()}>4 * 4</div>}
                {currectGameInfo.gridSize === "6by6" &&<div className='gridSizeItems' style={Selected} onClick={() => gridIs6()}>6 * 6</div>}
                {currectGameInfo.gridSize !== "6by6" &&<div className='gridSizeItems' style={NotSelected} onClick={() => gridIs6()}>6 * 6</div>}
            </div>
        </section>
