...
function Navigation() {
    ...
    const{ logOut,isLoggedIn, username,receiveUserAvatar } = useContext(AuthContext);
  ...
  return (
    <div id='navigationContainer' style={{right: menuOpen ? "0" : "-100%"}}>
        ...
        <div id='navItemsContainer' style={{paddingTop: isLoggedIn ? "40px" : "80px"}}>
            ...
            <Link to="/leaderboard" className='links'><div className='navItems'> <div className='navThumbnailDiv'><img src={leaderBoardIcon} alt='' style={{width: "30px",position: "relative", left: "-4px"}} className="bigIcons"/> </div> <p>Leaderboard</p> </div></Link>
